    ...
    <div className="admin-dashboard">
      ...
      <div className="dashboard-stats">
        ...
        <div className="stats-box stats-events">
          ...
          <p className="stats-value">
            {dashboardSummary?.totalEvents ?? "N/A"}
          </p>
        </div>
      </div>
      ...
      <div className="recent-section">
            ...
            <ul>
              {dashboardSummary?.latest2Inquiry?.map((inquiry) => (
                <li key={inquiry._id}>
                  ...
                  <span>
                    {inquiry?.joiningDate &&
                    moment(inquiry?.joiningDate).isValid()
        ...
        {dashboardSummary?.latest2ClassSchedule ? (
          <div className="recent recent-inquiries">
            ...
            <ul>
              {dashboardSummary?.latest2ClassSchedule?.map((event) => (
                <li key={event._id}>
                  ...
                  <span>
                    {event?.fromDate && moment(event?.fromDate).isValid()
        ...
        {dashboardSummary?.latest2Event ? (
          <div className="recent recent-inquiries recent-events">
