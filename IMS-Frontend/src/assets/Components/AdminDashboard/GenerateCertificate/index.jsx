      ...
      <br/>
          ...
          <form>
            ...
            <div className="form-section">
              ...
              <div className="form-group">
                <label htmlFor="certificate-attachment">Certificate Attachment:</label>
                <input
                  type="file"
        ...
        <div className="table-responsive">
          <table id="certificate-table">
            ...
            <tbody>
              ...
              <tr>
                <td>
                  <img src={userLogo} className="certificate-table-img" alt="User" />
                </td>
                <td>123456</td>
                ...
                <td>2024-06-15</td>
                <td>
                  <a href="certificate1.pdf" className="edit-btn" target="_blank" rel="noopener noreferrer">
                    View Certificate
                  </a>
                </td>
              </tr>
              <tr>
                <td>
                  <img src={userLogo} alt="User" className="certificate-table-img" />
                </td>
                <td>789012</td>
                <td>Manthan Patel</td>
                <td>B</td>
                <td>2024-06-20</td>
                <td>
                  <a href="certificate2.pdf" className="edit-btn" target="_blank" rel="noopener noreferrer">
                    View Certificate
                  </a>
                </td>
              </tr>
